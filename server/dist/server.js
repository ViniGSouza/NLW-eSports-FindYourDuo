...
app.get('/api', (request, response) => {
    response.send("Conexão com API realizada.");
});
app.get('/api/games', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
...
app.post('/api/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
...
app.get('/api/games/:id/ads', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const gameId = request.params.id;
...
app.get('/api/ads/:id/discord', (request, response) => __awaiter(void 0, void 0, void 0, function* () {
